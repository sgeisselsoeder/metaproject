...
for projectName in blender3d pacman wise21_p1_a2.5_loesung kigraph heimauto heimsprech kooperation berufung arbeitszeugnisse
do
	if [ ! -d "$projectName" ]; then
...
for projectName in 2022_wise_ki1_vorlesung 2022_wise_ki1_a1
do
	if [ ! -d "$projectName" ]; then
